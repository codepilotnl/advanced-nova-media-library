<template>
  <gallery-item class="gallery-item-image" :class="{ 'show-statistics': field.showStatistics }">
    <div class="gallery-item-info p-3">
      ...
      <a v-if="editable" class="icon focus" href="#" @click.prevent="$emit('focus-start', image)">
        <icon type="view" view-box="0 0 20 20" width="20" height="16" />
      </a>
    </div>
    ...
    <div v-if="field.showStatistics" class="type">{{ mimeType }}</div>
  </gallery-item>
</template>
